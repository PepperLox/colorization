...
# range [0, 1], and then convert the image from the BGR to Lab colordd
# space
image=cv2.UMat(cv2.imread(args["image"]))
imageUmat= cv2.UMat(image)
scaled=imageUmat.astype("float32")/255.0  #Can't find img file
